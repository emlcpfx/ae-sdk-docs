# Scripting (ExtendScript / AEGP)

> 128 Q&As · source: AE plugin dev community Discord
...
*Tags: `build`, `cross-platform`, `scripting`*
...
*Tags: `cep`, `plugin-communication`, `scripting`*
...
*Tags: `expressions`, `render-loop`, `scripting`, `workaround`*
