...
**10 entries** tagged with `extendscript`.
...
*Contributors: [**Justin**](../contributors/justin/), [**Alex Bizeau (maxon)**](../contributors/alex-bizeau-maxon/) · Source: adobe-plugin-devs · 2024-04-09 · Tags: `xmp`, `metadata`, `extendscript`, `project-data`, `storage`*
