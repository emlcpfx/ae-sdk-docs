...
*Contributors: [**gabgren**](../contributors/gabgren/) · Source: adobe-plugin-devs · 2022-02-27 · Tags: `mfr`, `multi-frame-rendering`, `plugin-update`, `thread-safety`*
...
*Tags: `reference`, `open-source`, `mfr`, `tool`*
